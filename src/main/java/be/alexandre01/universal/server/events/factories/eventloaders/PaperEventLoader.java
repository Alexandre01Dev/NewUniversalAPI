package be.alexandre01.universal.server.events.factories.eventloaders;

import be.alexandre01.universal.server.events.factories.CustomEventLoader;
...
public class PaperEventLoader extends CustomEventLoader {
    public Map<Class<? extends Event>, Set<RegisteredListener>> createCustomRegisteredListeners(Listener listener, Plugin plugin, EventPriority ep) {
        ...
        this.spigotPlugin.getServer().getPluginManager().useTimings();
        ...
        for (Method method : methods) {
            ...
            for (Class<?> clazz = eventClass; Event.class.isAssignableFrom(clazz); clazz = clazz.getSuperclass()) {
                if (clazz.getAnnotation(Deprecated.class) != null) {
                    ...
                    Warning.WarningState warningState = this.spigotPlugin.getServer().getWarningState();
