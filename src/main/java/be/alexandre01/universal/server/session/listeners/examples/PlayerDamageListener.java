...
import be.alexandre01.universal.server.session.listeners.examples.damages.InstaKill;
import be.alexandre01.universal.server.session.listeners.examples.damages.InstaKillByBlock;
import be.alexandre01.universal.server.session.listeners.examples.damages.InstaKillByEntity;
import be.alexandre01.universal.server.session.listeners.examples.damages.InstaKillOnVoid;
